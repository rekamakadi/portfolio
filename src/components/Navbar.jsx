...
const Navbar = () => {
  ...
  return (
    <div className='flex text-2x1 justify-between text-gray-200 items-center px-6 max-w-[1300px] mx-auto h-24'>
        <a href="">Réka Makádi</a>

        <ul className='hidden md:flex gap-12 z-10 cursor.pointer'>
            <li className='relative group'>
                <Link to="about" smooth={true} offset={50} duration={500}>About</Link>
                <span className='absolute bottom-0 left-0 w-full h-1 bg-purple-600 transform scale-x-0 group-hover:scale-x-100
