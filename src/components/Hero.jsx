...
const Hero = () => {
  return (
    <div className="grid md:grid-cols-2 place-items-center max-w-[1300px] mx-auto mb-8 md:mb-32 mt-14">
      <div className="max-w-[800px]">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4 md:mb-0">
          <a
            ...
            className="flex items-center justify-center transform transition-transform hover:scale-105 hover:shadow-lg
    z-10 cursor-pointer font-bold text-2xl text-gray-200 w-1/2 mt-6 p-2
